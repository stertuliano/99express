...
<?php
	    	        ...
	    	        echo $this->Form->control('price', ['label' => 'Preço:', 'type' => 'text', 'class' => 'price', 'value' => $this->Main->moneyBr($service->price)]);
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-xs-12 col-md-2"><?= $this->Form->control('add_aggregate_price', ['label' => false, 'placeholder' => '000.00', 'id' => 'add_aggregate_price', 'class' => 'price']);?></div>
						...
						<table class="table" id="table-aggregates">
							...
							<tbody>
								...
								<?php foreach($aggregates as $a){ ?>
									<tr>
										<td>
											<?= $this->Form->control('aggregates[name][]', ['value' => $a['name'], 'label' => false])?>
										</td>
										<td>
											<?= $this->Form->control('aggregates[description][]', ['value' => $a['description'], 'label' => false])?>
										</td>
										<td>
											<?= $this->Form->control('aggregates[price][]', ['value' => $this->Main->moneyBr($a['price']), 'class' => 'price', 'label' => false])?>
										</td>
										<td>
											<a href="#" onClick="removeLine(this);">remover</a>
										</td>
